...
# A sample Integer Program to solve the Knapsack problem
# using cxvpy library. This is taken from the following
# Medium post
...
knapsack_problem = cvxpy.Problem(
    cvxpy.Maximize(total_utility), [weight_constraint])
